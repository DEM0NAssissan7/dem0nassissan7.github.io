...
add_food("Chicken Quarter (boneless)", 0, 28.5);
...
add_food("Gouda Cheese", 2.2, 25);
add_food_amount("Hamburger Patties", 0, 18);
add_food("Kale", 5.6, 1.9);
add_food("Lamb Breast", 0, 25);
add_food_amount("Mushroom (white; bella) [per shroom]", 0.6, 0.6);
add_food("Mushroom (white; bella) [by weight]", 3.1, 3.3);
add_food_amount("Olives (small)", 0.3, 0);
...
add_food_amount("Sausage Patty", 0, 9);
